...
carpentry: "wvu"    # what kind of Carpentry (must be either "lc" or "dc" or "swc")
venue: "West Virginia University"        # brief name of host site without address (e.g., "Euphoric State University")
address: "One Waterfront Place"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
email: ["helpdesk@hpc.wvu.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
